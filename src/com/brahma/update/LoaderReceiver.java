...
public class LoaderReceiver extends BroadcastReceiver {
    ...
    public static final String UPDATE_GET_NEW_VERSION = "com.brahma.update.UPDATE_GET_NEW_VERSION";

    public static final String CHECKING_TASK_COMPLETED = "com.brahma.update.CHECKING_TASK_COMPLETED";
